...
import {
  View, Text, Image, StyleSheet, Dimensions, Clipboard, TouchableHighlight, Alert,
} from 'react-native';
  ...
  componentDidMount() {
    storage
      ...
      .then((walletInfo) => {
        ...
        const keystoreV3 = walletInfo.keystoreV3;
        this.setState({
          walletAddress,
          keystoreV3,
          PrivateKey: null,
    ...
    <Button
      ...
      onPress={() => {
					  this.setState(
                        ...
                        removeStore('walletInfo');
                        removeStore('token');
                        removeStore('walletName');
					                  this.refs.loading.close();
					                  this.navigate('Home');
					                } catch (error) {
					                  this.refs.loading.close();
