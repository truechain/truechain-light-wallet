            ...
            <View style={styles.container}>
                                ...
                                onPress: () => {
                                    try {
                                        ...
                                        storage.load({ key: 'walletInfo' }).then(res => {
                                            ...
                                            mneKeystore.keyFromPassword(this.state.walletPassword, (err, pwDerivedKey) => {
                                                let PrivateKey = '0x' + mneKeystore.exportPrivateKey(store.getState().walletInfo.wallet_address, pwDerivedKey);
                                                this.setState({
                                                    walletPassword: '',
                                                    PrivateKey
                                                })
                ...
                <Modal style={styles.privateKey} position={"center"} ref={"privateKey"} swipeArea={20}>
                    ...
                    <TouchableHighlight style={[styles.spacing, styles.privateKeyWarning]}>
                        <View>
                            <Text style={styles.warining_text}>
