...
class LockPosition extends Component {
	...
	static navigationOptions = ({ navigation }) => ({
		headerTitle: I18n.t('public.lockedWarehouse')
		//'锁仓'
	});
			...
			(err, tx) => {
				if (err) {
					...
					setTimeout(() => {
						...
						alert(I18n.t('node.publishDealFail'))
						// alert('发布交易失败，请稍后重试！');
					}, 100);
				} else {
					this.refs.loading.close();
			...
			<View style={styles.inputPage}>
				<View style={styles.infoBox}>
					<Text style={styles.infoBoxTitle}>
						{/* 锁仓地址 */}
						{ I18n.t('public.lockedWarehouseAddr') }
					</Text>
					...
					<View style={styles.gasPrice}>
						<Text>
							{/* 慢 */}
							{ I18n.t('currency.transferSpeedSlow') }
						</Text>
						<Text style={styles.textAlign}>{this.show(this.state.cost)}ether</Text>
						<Text>
							{/* 快 */}
							{ I18n.t('currency.transferSpeedFast') }
						</Text>
					</View>
				</View>
				<RadiusBtn
					...
					<View style={styles.success}>
						<View style={styles.success_item}>
							<Text style={styles.success_text}>
								{/* 报名成功 */}
								{ I18n.t('public.signSuccess') }
							</Text>
							<Text style={styles.marginBottom}>
								{/* 恭喜您报名成功！ */}
								{ I18n.t('public.subSignSuccess') }
							</Text>
							<RadiusBtn
							...
							<View style={styles.modalBottomBtn}>
								...
								>
									<View style={styles.modalBottomBtnNo}>
										<Text style={styles.modalBottomBtnNoText}>
											{/* 取消 */}
