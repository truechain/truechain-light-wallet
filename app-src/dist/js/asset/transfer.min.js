		...
		submitForm: function submitForm() {
			...
			$('#next').on('tap', function() {
				...
				if(that.addFlag) {
					...
					document.getElementById('fromAddress').innerHTML = that.fromAddress;
					document.getElementById('amountItem').innerHTML = that.amount + '  ETH';
				}
			});
			//最后确认支付按钮(跳转到支付页面)
