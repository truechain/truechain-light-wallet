			...
			submitForm: function submitForm() {
				...
				$('.comfirmPsw').on('tap', function() {
					...
					if(that.pswFlag) {
						...
						//$('#modal').addClass('mui-active');											
						function sendEth() {
							var keystore = JSON.parse(plus.storage.getItem('keystore'));
							...
							web3.eth.sendTransaction({
								...
								console.log(error + '4646464646');
								console.log(hash + '575757575757');
							});
						};
						if(currencyName == 'ETH') {
							sendEth();
							...
							function sendToken(fromAddr, toAddr, valueToken, pwd) {
								mui.plusReady(function() {
									...
									var contractAddr = '0x24026489887342e7615815487ffc33a01e7d2d46'; //TTR合约地址
