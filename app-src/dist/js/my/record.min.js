...
mui.plusReady(function() {
	let add = '0x' + plus.storage.getItem('walletAddress');
	mui.ajax("http://api.etherscan.io/api?module=account&action=txlist&address=" + add + "&startblock=0&endblock=99999999&sort=asc&apikey=YourApiKeyToken", {
		dataType: 'json',
		type: 'get',
		timeout: 9999999999,
		headers: {
